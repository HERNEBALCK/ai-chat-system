    ...
    <div class="articleDetail-container">
        ...
        <div class="content">
            <div class="diary-card">
                ...
                <div class="sub-title">
                    <el-tag class="category-tag" size="large" Plain type="primary">{{ articleDetail.categoryName }}</el-tag>
                    <div class="flex-box">
                ...
                <div class="diary-card">
                    ...
                    <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length">
                        <h4 class="tags-title">相关标签</h4>
                            <div class="tags-list">
                                <el-tag v-for="tag in articleDetail.tagArray" :key="tag" effect="light" Plain type="info">{{ tag }}</el-tag>
                            </div>
                    </div>
                </div>
            </div>
